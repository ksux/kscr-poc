...
// Implementation of the Namespace NPM module.
// https://github.com/emgee3/namecase
// https://github.com/emgee3/namecase/blob/master/namecase.js
...
angular.module('kscrPocApp')
  .filter('namecase', function () {
    ...
    return function (input) {
      ...
      return NameCase.singleField(input);
    };
  });
